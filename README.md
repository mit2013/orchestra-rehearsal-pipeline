...
|---|---|---|
| 合奏1 | 00:01:22 – 00:44:21 | 頭・尻とも「よい」 |
| 合奏2 | 00:47:13 – 01:34:51 | 頭・尻とも「よい」 |
| 合奏3 | 01:42:20 – 03:00:04 | 頭・尻とも「よい」 |
...
`TUNING_PRE_ROLL_S` は **0**(検出位置ちょうどが合奏の開始)。以前は 5 秒だった。
`tuning.py` は核となる区間を見つけたあと倍音で頭を前へ伸ばすので、**報告される
開始は実際に A が鳴り出すより手前**にある。260829 の実測では A の成分比率が
検出位置で 0.03〜0.11、+0.5 秒で 0.33〜0.68 だった。余裕は検出側で取れているので、
ここで重ねると手前の音出しと無音が入るだけになる。
